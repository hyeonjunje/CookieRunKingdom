...
public class KingdomHotAirBalloonState : KingdomBaseState
{
    public KingdomHotAirBalloonState(KingdomStateFactory factory, KingdomManager manager) : base(factory, manager)
    {
    }
