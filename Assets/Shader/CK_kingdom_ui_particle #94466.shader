...
void main()
{
    ...
    u_xlat0.xy = in_TEXCOORD0.xy * _SubTex_ST.xy + _SubTex_ST.zw;
    vs_TEXCOORD1.xy = vec2(_SBtexSpdX, _SBtexSpdY) * _Time.yy + u_xlat0.xy;
    u_xlat0.xy = in_TEXCOORD0.xy * _Atex_ST.xy + _Atex_ST.zw;
    vs_TEXCOORD2.xy = vec2(_AtexSpdX, _AtexSpdY) * _Time.yy + u_xlat0.xy;
    u_xlat0.xy = in_TEXCOORD0.xy * _Dtex_ST.xy + _Dtex_ST.zw;
    vs_TEXCOORD3.xy = vec2(_DtexSpdX, _DtexSpdY) * _Time.yy + u_xlat0.xy;
    u_xlat0.xy = in_TEXCOORD0.xy * _Dstex_ST.xy + _Dstex_ST.zw;
...
void main()
{
    ...
    u_xlat3.xy = in_TEXCOORD0.xy * PropsArray[u_xlati0 / 14]._SubTex_ST.xy + PropsArray[u_xlati0 / 14]._SubTex_ST.zw;
    vs_TEXCOORD1.xy = vec2(PropsArray[u_xlati0 / 14]._SBtexSpdX, PropsArray[u_xlati0 / 14]._SBtexSpdY) * _Time.yy + u_xlat3.xy;
    u_xlat3.xy = in_TEXCOORD0.xy * PropsArray[u_xlati0 / 14]._Atex_ST.xy + PropsArray[u_xlati0 / 14]._Atex_ST.zw;
    vs_TEXCOORD2.xy = vec2(PropsArray[u_xlati0 / 14]._AtexSpdX, PropsArray[u_xlati0 / 14]._AtexSpdY) * _Time.yy + u_xlat3.xy;
    u_xlat3.xy = in_TEXCOORD0.xy * PropsArray[u_xlati0 / 14]._Dtex_ST.xy + PropsArray[u_xlati0 / 14]._Dtex_ST.zw;
    vs_TEXCOORD3.xy = vec2(PropsArray[u_xlati0 / 14]._DtexSpdX, PropsArray[u_xlati0 / 14]._DtexSpdY) * _Time.yy + u_xlat3.xy;
    u_xlat3.xy = in_TEXCOORD0.xy * PropsArray[u_xlati0 / 14]._Dstex_ST.xy + PropsArray[u_xlati0 / 14]._Dstex_ST.zw;
...
void main()
{
    ...
    if(u_xlatb4){discard;}
    u_xlat16_4.xy = texture(_Dtex, vs_TEXCOORD3.xy).xy;
    u_xlat12 = PropsArray[0]._Di * 0.5;
    u_xlat1 = u_xlat16_4.xyxy * vec4(PropsArray[0]._Di) + (-vec4(u_xlat12));
