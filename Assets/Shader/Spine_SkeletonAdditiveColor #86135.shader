...
//
///////////////////////////////////////////
Shader "Spine/SkeletonAdditiveColor" {
Properties {
...
void main()
{
    u_xlat16_0 = _GlobalAdditiveColor.w * _GlobalAdditiveIntensity;
    ...
    u_xlat3.xyz = _GlobalAdditiveColor.xyz * u_xlat1.www + (-u_xlat2.xyz);
    u_xlat1.xyz = vec3(u_xlat16_0) * u_xlat3.xyz + u_xlat2.xyz;
...
void main()
{
    ...
    u_xlat3.xyz = _AdditiveColor.xyz * u_xlat1.www + (-u_xlat2.xyz);
    u_xlat2.xyz = _AdditiveColor.www * u_xlat3.xyz + u_xlat2.xyz;
    u_xlat3.xyz = _GlobalAdditiveColor.xyz * u_xlat1.www + (-u_xlat2.xyz);
    u_xlat1.xyz = vec3(u_xlat16_0) * u_xlat3.xyz + u_xlat2.xyz;
    SV_Target0 = u_xlat1 * vs_COLOR0;
    return;
