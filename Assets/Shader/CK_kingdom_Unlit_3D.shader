...
[Toggle(CUTOFF)] _isCutOff ("CUTOFF", Float) = 0
...
void main()
{
    ...
    u_xlati4 = u_xlati4 * 14;
    u_xlat0 = u_xlat16_0 + (-PropsArray[u_xlati4 / 14]._Dsi);
#ifdef UNITY_ADRENO_ES3
    u_xlatb8 = !!(u_xlat0<0.0);
#else
    u_xlatb8 = u_xlat0<0.0;
#endif
    u_xlat0 = (-u_xlat0) + PropsArray[u_xlati4 / 14]._DsEdgeRange;
    u_xlat0 = max(u_xlat0, 0.0);
    u_xlat0 = u_xlat0 * PropsArray[u_xlati4 / 14]._DsEdgeMul;
    u_xlat0 = min(u_xlat0, 1.0);
    if(u_xlatb8){discard;}
    u_xlat16_8.xy = texture(_Dtex, vs_TEXCOORD3.xy).xy;
    u_xlat1.x = 0.5 * PropsArray[u_xlati4 / 14]._Di;
    u_xlat1 = u_xlat16_8.xyxy * vec4(PropsArray[u_xlati4 / 14]._Di) + (-u_xlat1.xxxx);
    u_xlat1 = u_xlat1 * vec4(PropsArray[u_xlati4 / 14]._Di, PropsArray[u_xlati4 / 14]._Di, PropsArray[u_xlati4 / 14]._SBDi, PropsArray[u_xlati4 / 14]._SBDi) + phase0_Input0_2;
    u_xlat16_2 = texture(_SubTex, u_xlat1.zw);
    u_xlat16_1 = texture(_MainTex, u_xlat1.xy);
    u_xlat8 = u_xlat16_2.w * PropsArray[u_xlati4 / 14]._SBtexC.w;
    u_xlat8 = u_xlat8 * PropsArray[u_xlati4 / 14]._SBMix;
    u_xlat3 = u_xlat16_1 * vs_COLOR0;
    u_xlat1.xyz = u_xlat16_2.xyz * PropsArray[u_xlati4 / 14]._SBtexC.xyz + (-u_xlat3.xyz);
    u_xlat1.xyz = vec3(u_xlat8) * u_xlat1.xyz + u_xlat3.xyz;
    u_xlat2.xyz = (-u_xlat1.xyz) + (-PropsArray[u_xlati4 / 14]._DsEdgeC.xyz);
    u_xlat2.xyz = vec3(u_xlat0) * u_xlat2.xyz + u_xlat1.xyz;
    u_xlat16_0 = texture(_Atex, vs_TEXCOORD2.xy).x;
    u_xlat0 = (-u_xlat16_1.w) * vs_COLOR0.w + u_xlat16_0;
    u_xlat0 = PropsArray[u_xlati4 / 14]._Ai * u_xlat0 + u_xlat3.w;
    u_xlat2.w = u_xlat0 * u_xlat3.w;
    u_xlat1 = u_xlat2 * PropsArray[u_xlati4 / 14]._MtexC;
    SV_Target0.w = u_xlat1.w * PropsArray[u_xlati4 / 14]._Fade;
...
void main()
{
    ...
    u_xlat8 = _Di * 0.5;
    u_xlat0 = u_xlat10_0.xyxy * vec4(_Di) + (-vec4(u_xlat8));
    u_xlat0 = u_xlat0 * vec4(_Di, _Di, _SBDi, _SBDi) + phase0_Input0_2;
    u_xlat10_1 = texture2D(_MainTex, u_xlat0.xy);
    u_xlat10_0 = texture2D(_SubTex, u_xlat0.zw);
    u_xlat2 = u_xlat10_1.w * vs_COLOR0.w + (-_CutOff);
    u_xlatb2 = u_xlat2<0.0;
    if(u_xlatb2){discard;}
    u_xlat10_2 = texture2D(_Dstex, vs_TEXCOORD4.xy).x;
    u_xlat2 = u_xlat10_2 + (-_Dsi);
    u_xlatb6 = u_xlat2<0.0;
    u_xlat2 = (-u_xlat2) + _DsEdgeRange;
    u_xlat2 = max(u_xlat2, 0.0);
    u_xlat2 = u_xlat2 * _DsEdgeMul;
    u_xlat2 = min(u_xlat2, 1.0);
    if(u_xlatb6){discard;}
    u_xlat12 = u_xlat10_0.w * _SBtexC.w;
    u_xlat12 = u_xlat12 * _SBMix;
    u_xlat3 = u_xlat10_1 * vs_COLOR0;
    u_xlat0.xyz = u_xlat10_0.xyz * _SBtexC.xyz + (-u_xlat3.xyz);
    u_xlat0.xyz = vec3(u_xlat12) * u_xlat0.xyz + u_xlat3.xyz;
    u_xlat1.xyz = (-u_xlat0.xyz) + (-_DsEdgeC.xyz);
    u_xlat0.xyz = vec3(u_xlat2) * u_xlat1.xyz + u_xlat0.xyz;
    u_xlat10_1.x = texture2D(_Atex, vs_TEXCOORD2.xy).x;
    u_xlat1.x = (-u_xlat10_1.w) * vs_COLOR0.w + u_xlat10_1.x;
    u_xlat1.x = _Ai * u_xlat1.x + u_xlat3.w;
    u_xlat0.w = u_xlat1.x * u_xlat3.w;
...
void main()
{
    ...
    u_xlat8 = _Di * 0.5;
    u_xlat0 = u_xlat16_0.xyxy * vec4(_Di) + (-vec4(u_xlat8));
    u_xlat0 = u_xlat0 * vec4(_Di, _Di, _SBDi, _SBDi) + phase0_Input0_2;
    u_xlat16_1 = texture(_MainTex, u_xlat0.xy);
    u_xlat16_0 = texture(_SubTex, u_xlat0.zw);
    u_xlat2 = u_xlat16_1.w * vs_COLOR0.w + (-_CutOff);
#ifdef UNITY_ADRENO_ES3
    u_xlatb2 = !!(u_xlat2<0.0);
#else
    u_xlatb2 = u_xlat2<0.0;
#endif
    if(u_xlatb2){discard;}
    u_xlat16_2 = texture(_Dstex, vs_TEXCOORD4.xy).x;
    u_xlat2 = u_xlat16_2 + (-_Dsi);
#ifdef UNITY_ADRENO_ES3
    u_xlatb6 = !!(u_xlat2<0.0);
#else
    u_xlatb6 = u_xlat2<0.0;
    ...
    u_xlat2 = min(u_xlat2, 1.0);
    if(u_xlatb6){discard;}
    u_xlat12 = u_xlat16_0.w * _SBtexC.w;
    u_xlat12 = u_xlat12 * _SBMix;
    u_xlat3 = u_xlat16_1 * vs_COLOR0;
    u_xlat0.xyz = u_xlat16_0.xyz * _SBtexC.xyz + (-u_xlat3.xyz);
    u_xlat0.xyz = vec3(u_xlat12) * u_xlat0.xyz + u_xlat3.xyz;
    u_xlat1.xyz = (-u_xlat0.xyz) + (-_DsEdgeC.xyz);
    u_xlat0.xyz = vec3(u_xlat2) * u_xlat1.xyz + u_xlat0.xyz;
    u_xlat16_1.x = texture(_Atex, vs_TEXCOORD2.xy).x;
...
void main()
{
    ...
    u_xlat12 = 0.5 * PropsArray[u_xlati8 / 14]._Di;
    u_xlat1 = u_xlat16_0.xyxy * vec4(PropsArray[u_xlati8 / 14]._Di) + (-vec4(u_xlat12));
    ...
    u_xlat16_1 = texture(_SubTex, u_xlat1.zw);
    u_xlat0 = u_xlat16_2.w * vs_COLOR0.w + (-_CutOff);
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat0 = u_xlat16_0.x + (-PropsArray[u_xlati8 / 14]._Dsi);
#ifdef UNITY_ADRENO_ES3
    u_xlatb4 = !!(u_xlat0<0.0);
#else
    u_xlatb4 = u_xlat0<0.0;
#endif
    u_xlat0 = (-u_xlat0) + PropsArray[u_xlati8 / 14]._DsEdgeRange;
    u_xlat0 = max(u_xlat0, 0.0);
    u_xlat0 = u_xlat0 * PropsArray[u_xlati8 / 14]._DsEdgeMul;
    u_xlat0 = min(u_xlat0, 1.0);
    if(u_xlatb4){discard;}
    u_xlat4 = u_xlat16_1.w * PropsArray[u_xlati8 / 14]._SBtexC.w;
    u_xlat4 = u_xlat4 * PropsArray[u_xlati8 / 14]._SBMix;
    u_xlat3 = u_xlat16_2 * vs_COLOR0;
    u_xlat1.xyz = u_xlat16_1.xyz * PropsArray[u_xlati8 / 14]._SBtexC.xyz + (-u_xlat3.xyz);
    u_xlat1.xyz = vec3(u_xlat4) * u_xlat1.xyz + u_xlat3.xyz;
    ...
    u_xlat0 = (-u_xlat16_2.w) * vs_COLOR0.w + u_xlat16_0.x;
    u_xlat0 = PropsArray[u_xlati8 / 14]._Ai * u_xlat0 + u_xlat3.w;
    u_xlat1.w = u_xlat0 * u_xlat3.w;
    u_xlat1 = u_xlat1 * PropsArray[u_xlati8 / 14]._MtexC;
